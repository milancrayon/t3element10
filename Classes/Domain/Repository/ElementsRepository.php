    ...
    public function elementOperations($data){
        ...
        if(sizeof($data['tt_content']) > 0){
            ...
            foreach($data['tt_content'] as $ttcontent){ 
                ...
                $addColumn = "ALTER TABLE tt_content ADD ".$ttcontent['val'];
                $modifycolumn  = "ALTER TABLE tt_content MODIFY COLUMN ".$ttcontent['val'];
    ...
    public function elementUpdate($element){
        ...
        if(sizeof($tt_content['newfield']) > 0){
            foreach($tt_content['newfield'] as $nFld){
                ...
                if($checkforColumn){
                    $modifycolumn  = "ALTER TABLE tt_content MODIFY COLUMN ".$nFld['val'];
                    ...
                    $addColumn = "ALTER TABLE tt_content ADD ".$nFld['val'];
